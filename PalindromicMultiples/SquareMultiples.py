...
def algo4(n, output=None):
    ...
    orderedReached.append((1, 3))
    pathTo[(1, 3)] = (None, "0")
    orderedReached.append((2, 3))
    pathTo[(2, 3)] = (None, "1")
...
if __name__ == "__main__":
    ...
    if False: # Ran up to 49148
        memory_limit(0.4)
        n = 3
        with open("output.txt", "a") as outputFile: # n k nk algo1time algo2time algo3time algo4time algo5time
            while n < 1000000:
    ...
    if True:
        memory_limit(0.4)
        n = 3
        with open("SquareOutput.txt", "a") as outputFile: # n k nk algo
            while n < 10000000:
                result = algo1(n)
                if result[0] == -1:
                    print(result)
